...
gmx mdrun -deffnm step6.3_equilibration -nb gpu -bonded gpu -gpu_id 0 -ntmpi 1 -ntomp 8 -plumed plumed_pull1.dat
...
gmx mdrun -deffnm step6.4_equilibration -nb gpu -bonded gpu -gpu_id 0 -ntmpi 1 -ntomp 8 -plumed plumed_pull2.dat
...
gmx mdrun -deffnm step6.5_equilibration -nb gpu -bonded gpu -gpu_id 0 -ntmpi 1 -ntomp 8 -plumed plumed_pull3.dat
...
gmx mdrun -deffnm step6.6_equilibration -nb gpu -bonded gpu -gpu_id 0 -ntmpi 1 -ntomp 8 -plumed plumed_wall.dat
