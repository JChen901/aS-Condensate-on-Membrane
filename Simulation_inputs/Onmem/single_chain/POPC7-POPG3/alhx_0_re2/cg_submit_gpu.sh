...
gmx mdrun -deffnm step6.2_equilibration -nb gpu -bonded gpu -update gpu -gpu_id 1 -ntmpi 1 -ntomp 8 -cpi
...
gmx mdrun -deffnm step6.3_equilibration -nb gpu -bonded gpu -gpu_id 1 -ntmpi 1 -ntomp 8
...
gmx mdrun -deffnm step6.4_equilibration -nb gpu -bonded gpu -gpu_id 1 -ntmpi 1 -ntomp 8 
...
gmx mdrun -deffnm step6.5_equilibration -nb gpu -bonded gpu -gpu_id 1 -ntmpi 1 -ntomp 8 
...
gmx mdrun -deffnm step6.6_equilibration -nb gpu -bonded gpu -gpu_id 1 -ntmpi 1 -ntomp 8 
