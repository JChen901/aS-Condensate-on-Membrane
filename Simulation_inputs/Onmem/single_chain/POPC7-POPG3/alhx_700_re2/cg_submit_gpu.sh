...
gmx mdrun -deffnm step6.3_equilibration -nb gpu -bonded gpu -gpu_id 2 -ntmpi 1 -ntomp 8
...
gmx mdrun -deffnm step6.4_equilibration -nb gpu -bonded gpu -gpu_id 2 -ntmpi 1 -ntomp 8
...
gmx mdrun -deffnm step6.5_equilibration -nb gpu -bonded gpu -gpu_id 2 -ntmpi 1 -ntomp 8
...
gmx mdrun -deffnm step6.6_equilibration -nb gpu -bonded gpu -gpu_id 2 -ntmpi 1 -ntomp 8 


# Production
gmx grompp -f mdp/step7_production.mdp -o step7_production.tpr -c step6.6_equilibration.gro -r $gro_posre -p $top -n index.ndx
'''
gmx mdrun -deffnm step7_production -nb gpu -bonded gpu -update gpu -gpu_id 2 -ntmpi 1 -ntomp 8 -cpi
