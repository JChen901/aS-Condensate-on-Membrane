...
#Equilibration
gmx grompp -f mdp/step4.2_equilibration.mdp -o step4.2_equilibration.tpr -c step4.1_minimization.gro -r system.gro -p system.top -n index.ndx -maxwarn 2
gmx mdrun -deffnm step4.2_equilibration -nb gpu -bonded gpu -gpu_id 0 -ntmpi 1 -ntomp 8 

#Production
gmx grompp -f mdp/step5_production.mdp -o step5_production.tpr -c step4.2_equilibration.gro -p system.top -n index.ndx 
'''
gmx mdrun -deffnm step5_production -nb gpu -bonded gpu -gpu_id 2 -ntmpi 1 -ntomp 8 -cpi
