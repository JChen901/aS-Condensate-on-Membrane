...
CONTACT_MODE_SHORT_LABELS = {
    ...
    "three_antisymmetric_nac_bb": r"$\geq$3 anti.",
    "antisymmetric_nac_bb": r"$\geq$1 anti.",
    "triplet_antisymmetric_nac_bb": "3 anti consec.",
}
...
CONTACT_MODE_TITLES = {
    ...
    "three_antisymmetric_nac_bb": "Any 3 antisymmetric BB contacts",
    "antisymmetric_nac_bb": "Any 1 antisymmetric BB contact",
    "triplet_antisymmetric_nac_bb": "3 consecutive antisymmetric BB contacts",
}
