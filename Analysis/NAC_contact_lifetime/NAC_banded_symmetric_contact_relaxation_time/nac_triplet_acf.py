...
from nac_triplet_relaxation import (
    ...
    build_banded_symmetric_indices,
...
NAC_ACF_CACHE_CSV = "nac_triplet_symmetric_acf_data.csv"
NAC_ACF_SUMMARY_CSV = "nac_triplet_symmetric_acf_summary.csv"
NAC_ACF_TRAJ_SUMMARY_CSV = "nac_triplet_symmetric_acf_trajectory_summary.csv"
...
def run_nac_contact_acf_analysis_multi(
    ...
    for group in groups:
        ...
        print("=" * 80)
        print(f"Processing shared symmetric {acf_kind} ACF scan: {group_label}")
                ...
                traj_summary_rows_by_mode[contact_mode].append(
                    {
                        ...
                        "symmetric_window": acf["symmetric_window"],
                    }
                )
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Calculate symmetric NAC BB contact autocorrelation functions for the dense M3IDP trajectories."
    )
    parser.add_argument(
        "--group",
        action="append",
