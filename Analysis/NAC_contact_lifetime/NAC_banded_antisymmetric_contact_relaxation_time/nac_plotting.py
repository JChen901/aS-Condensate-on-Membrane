...
CONTACT_MODE_SHORT_LABELS = {
    ...
    "three_antisymmetric_nac_bb": r"$\geq$3 band anti.",
    "antisymmetric_nac_bb": r"$\geq$1 band anti.",
    "triplet_antisymmetric_nac_bb": "3 band anti consec.",
}
...
CONTACT_MODE_TITLES = {
    ...
    "three_antisymmetric_nac_bb": "Any 3 banded antisymmetric BB contacts",
    "antisymmetric_nac_bb": "Any 1 banded antisymmetric BB contact",
    "triplet_antisymmetric_nac_bb": "3 consecutive banded antisymmetric BB contacts",
}

PLOT_CONTEXT_LABELS = {
    "nac_contact_survival": "NAC contact survival",
    "nac_antisymmetric_contact_survival": "NAC antisymmetric contact survival",
    "nter_contact_survival": "N-ter contact survival",
    "cter_contact_survival": "C-ter contact survival",
    "nac_contact_acf": "NAC contact ACF",
    "nac_antisymmetric_contact_acf": "NAC antisymmetric contact ACF",
