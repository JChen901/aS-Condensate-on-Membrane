...
CONTACT_MODE_SHORT_LABELS = {
    ...
    "three_corresponding_nac_bb": r"$\geq$3 corr.",
    "corresponding_nac_bb": r"$\geq$1 corr.",
    "triplet_corresponding_nac_bb": "3 consec.",
}
...
CONTACT_MODE_TITLES = {
    ...
    "three_corresponding_nac_bb": "Any 3 corresponding BB contacts",
    "corresponding_nac_bb": "Any 1 corresponding BB contact",
    "triplet_corresponding_nac_bb": "3 consecutive corresponding BB contacts",
}
